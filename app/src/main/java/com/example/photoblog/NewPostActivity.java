...
public class NewPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true); // this for beck Button at Toolbar
        ...
        newPostBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(desc) && postImageUri !=null){
                    ...
                    reg_progress.setTitle("Uploading");
                                        ...
                                        firebaseFirestore.collection("Posts").add(postMap)
                                                .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<DocumentReference> task) {
                                                        if(task.isSuccessful()){
                                                            Toast.makeText(NewPostActivity.this, "Post shared...", Toast.LENGTH_SHORT).show();
                                                            sendToMain();
                                                        }else {
                                                            // Error Handling
